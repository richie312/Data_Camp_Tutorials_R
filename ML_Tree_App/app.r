...
library(rsconnect)
rsconnect::setAccountInfo(name='richienirvikalpa',
                          token='14AABD64A4590AB448323B2E98619A8F',
                          secret='uN4etr305OwfYCvpJ3NklG+K54sxATmkQCSd4otc')
...
server<- shinyServer(function(input,output){
 ...
 plot_cptable_nsplit<-reactive({
  ...
  ## ROC
    ...
    output$List<-renderDataTable({head(Pred())})
